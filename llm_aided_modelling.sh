...
SPEC_FILE="Specs/$WORK_DIR.json" #CHANGE
SPEC_FILE_TEST="$WORK_DIR/specs/$WORK_DIR.json" #CHANGE
FIGURE_FILE="Figures/$WORK_DIR.png" #CHANGE
...
PDF_FILE="Pdfs/design_guide.pdf"
TESTBENCH_PROMPT="Testbenches/testbench_prompt.txt"
EQUATION_DATABASE="circuit_equation_library.txt"
